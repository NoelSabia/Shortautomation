...
def get_voice(str_to_voice: str, output_path: str="~/Documents/brainrot/voiceover/output.mp3") -> None:
	...
	for api_key in valid_api_keys:
		...
		try:
			...
			if e.status_code == 429:
				...
				print(Fore.YELLOW + f"\nThe API key {api_key} is not authorized. Check your API key settings but no urgent action needed!" + Style.RESET_ALL)
				continue
